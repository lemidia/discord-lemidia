...
export const ServerSearch = ({ data }: ServerSearchProps) => {
  ...
  useEffect(() => {
    const commandInvocationHandler = (e: KeyboardEvent) => {
    ...
    document.addEventListener("keydown", commandInvocationHandler);

    return () =>
      document.removeEventListener("keydown", commandInvocationHandler);
  }, []);
